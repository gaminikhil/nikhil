...
* Drop us a line at [http://www.algoritmika.com](http://www.algoritmika.com).

= More =
* Visit the [Payment Gateway Based Fees and Discounts for WooCommerce plugin page](https://wpfactory.com/item/payment-gateway-based-fees-and-discounts-for-woocommerce-plugin/).
...
* Fix - Issue on pay-order endpoint where Order ID were not available.
...
= 2.6 - 13/01/2020
* Fix - The fees was not being removed from checkout when a payment gateway was unset unsing custom code.
* Fix - Compatibility with WooCommerce Country based Payments plugin.
* Feature - Added an Ajax call on 'Pay Order' page. The fees will now be added/removed from the 'Pay Order' page as well.
...
* Fixed an issue where license key was not being activated successfully.
...
* On a fresh install of the plugin, the admin will now be prompted to enter the license key and activate the same.

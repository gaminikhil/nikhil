 ...
 *
 * @package checkout-fees-for-woocommerce-pro/args
 */
...
if ( ! class_exists( 'Alg_WC_Checkout_Fees_Args' ) ) :
	...
	/**
	 * Add the local/global settings to an array.
	 */
	class Alg_WC_Checkout_Fees_Args {
		...
		/**
		 * Get the global settings arguments.
		 *
		...
		/**
		 * Get the local settings arguments.
		 *
		 * @param string  $current_gateway Current selected gateway.
		 * @param integer $product_id Product ID.
		 * @param integer $variation_id Variation ID.
		 * @param integer $product_qty Product Quantity.
		 * @version 2.5.0
		 * @since   2.0.0
		 */

 ...
 *
 * @package checkout-fees-for-woocommerce-pro/settings/global-fee
 */
	...
	class Alg_WC_Checkout_Fees_Settings_Global_Extra_Fee extends Alg_WC_Checkout_Fees_Settings_Section {
		...
		public function get_settings() {
			...
			$settings = array(
				...
				array(
					'title'             => __( 'Remove the global fee on set values', 'checkout-fees-for-woocommerce' ),
				    'desc_tip'          => __( 'Enter min cart value.', 'checkout-fees-for-woocommerce' ),
					'id'                => 'alg_woocommerce_checkout_fees_golbal_min_fees',
					'default'           => 'no',
					'type'              => 'number',
					'placeholder'       => 'Enter Minimum Cart Value',
				),
				array(
				    'desc_tip'          => __( 'Enter Maximum cart value.', 'checkout-fees-for-woocommerce' ),
					'id'                => 'alg_woocommerce_checkout_fees_golbal_max_fees',
					'default'           => 'no',
					'type'              => 'number',

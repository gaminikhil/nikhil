  ...
  $('form#order_review').on('click', 'input[name="payment_method"]', () => {
    ...
    $.post('?wc-ajax=update_fees', data, (response) => {
      ...
      if (response && response.fragments) {
        ...
        if ('square_credit_card' === defaultPaymentMethod && window.wc_square_credit_card_payment_form_handler && pgf_checkout_params && pgf_checkout_params.alg_wc_square_card_payment_args) {

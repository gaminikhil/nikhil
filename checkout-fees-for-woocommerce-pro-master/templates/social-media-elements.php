...
<div class="social-items-wrap">
	...
	<a href="https://twitter.com/tychesoftwares" class="twitter-follow-button" data-show-count="false">
	<?php
		/* translators: %s: Twitter id */
		printf( esc_html_e( 'Follow %s', 'tychesoftwares' ), '@tychesoftwares' );
	?>
	</a>
